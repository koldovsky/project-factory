...
| `.claude/agents/*.md` | 9 specialized subagents (analyst, spec writer, implementer, test engineer, reviewers, auditor, QA documenter, bug triage) |
| `.claude/workflows/*.js` | 3 deterministic multi-agent workflows: `review-gate`, `spec-pipeline`, `uat-triage` |
...
| `scripts/*.reference.*` | Proven reference implementations: verification runner, demo recorder, UAT proof recorder, **traceability validator**, **coverage ratchet** |
