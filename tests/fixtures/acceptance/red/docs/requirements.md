...
**Pixel Copy Fixture (red)**

*Mirrors the 2026-07-02 pixel-perfect forensics case: acceptance methods are
declared on paper but no mechanism or artifact exists.*
...
|---|---|---|---|
| FR-1 | MVP | Content | Home page reproduces the live site's section order and copy. |
