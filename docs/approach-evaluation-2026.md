...
**Update 2026-06-21:** Upgrade in progress — step 1 (evals, §4.2), step 2 (scheduled automations, §4.1), and step 3 (test-first, §4.4) are landing. See [`evals/README.md`](../evals/README.md) and [`automations/README.md`](../automations/README.md).
**Reference corpus:**
